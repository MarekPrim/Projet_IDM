 ...
 * </p>
 * <ul>
 *   <li>{@link petrie.impl.PetriNetImpl#getName <em>Name</em>}</li>
 *   <li>{@link petrie.impl.PetriNetImpl#getPetriElements <em>Petri Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	protected EClass eStaticClass() {
		return PetriePackage.Literals.PETRI_NET;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetriePackage.PETRI_NET__NAME, oldName, name));
	}
	...
	public EList<PetriElement> getPetriElements() {
		if (petriElements == null) {
			petriElements = new EObjectContainmentWithInverseEList<PetriElement>(PetriElement.class, this, PetriePackage.PETRI_NET__PETRI_ELEMENTS, PetriePackage.PETRI_ELEMENT__PETRINET);
		}
