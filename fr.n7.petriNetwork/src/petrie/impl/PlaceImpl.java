 ...
 * </p>
 * <ul>
 *   <li>{@link petrie.impl.PlaceImpl#getMarking <em>Marking</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends NodeImpl implements Place {
	...
	protected EClass eStaticClass() {
		return PetriePackage.Literals.PLACE;
	}
	...
	public void setMarking(int newMarking) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetriePackage.PLACE__MARKING, oldMarking, marking));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PetriePackage.PLACE__MARKING:
				return getMarking();
		}
