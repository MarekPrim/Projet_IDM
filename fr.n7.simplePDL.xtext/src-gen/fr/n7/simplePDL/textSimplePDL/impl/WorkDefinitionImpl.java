 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.WorkDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.WorkDefinitionImpl#getNeeds <em>Needs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition
{
  ...
  {
    return TextSimplePDLPackage.Literals.WORK_DEFINITION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.WORK_DEFINITION__NAME, oldName, name));
  }
  ...
  public EList<Need> getNeeds()
  {
    if (needs == null)
    {
      needs = new EObjectContainmentEList<Need>(Need.class, this, TextSimplePDLPackage.WORK_DEFINITION__NEEDS);
    }
    return needs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TextSimplePDLPackage.WORK_DEFINITION__NEEDS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TextSimplePDLPackage.WORK_DEFINITION__NAME:
        return getName();
      case TextSimplePDLPackage.WORK_DEFINITION__NEEDS:
        return getNeeds();
    }
