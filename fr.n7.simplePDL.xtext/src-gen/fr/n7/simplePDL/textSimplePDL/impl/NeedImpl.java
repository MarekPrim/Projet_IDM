 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.NeedImpl#getNbResources <em>Nb Resources</em>}</li>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.NeedImpl#getResource <em>Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NeedImpl extends MinimalEObjectImpl.Container implements Need
{
  ...
  {
    return TextSimplePDLPackage.Literals.NEED;
  }
  ...
  public void setNbResources(int newNbResources)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.NEED__NB_RESOURCES, oldNbResources, nbResources));
  }
  ...
  public Resource getResource()
  {
    if (resource != null && resource.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TextSimplePDLPackage.NEED__RESOURCE, oldResource, resource));
      }
    }
    return resource;
  }
  ...
  public void setResource(Resource newResource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.NEED__RESOURCE, oldResource, resource));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TextSimplePDLPackage.NEED__NB_RESOURCES:
        return getNbResources();
      case TextSimplePDLPackage.NEED__RESOURCE:
