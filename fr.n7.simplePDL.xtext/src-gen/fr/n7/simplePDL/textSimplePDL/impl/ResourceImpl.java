 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.ResourceImpl#getNbAvailableResources <em>Nb Available Resources</em>}</li>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.ResourceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceImpl extends ProcessElementImpl implements Resource
{
  ...
  {
    return TextSimplePDLPackage.Literals.RESOURCE;
  }
  ...
  public void setNbAvailableResources(int newNbAvailableResources)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.RESOURCE__NB_AVAILABLE_RESOURCES, oldNbAvailableResources, nbAvailableResources));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.RESOURCE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TextSimplePDLPackage.RESOURCE__NB_AVAILABLE_RESOURCES:
        return getNbAvailableResources();
      case TextSimplePDLPackage.RESOURCE__NAME:
        return getName();
    }
