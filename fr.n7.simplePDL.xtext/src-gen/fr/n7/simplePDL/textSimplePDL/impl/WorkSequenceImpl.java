 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.WorkSequenceImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link fr.n7.simplePDL.textSimplePDL.impl.WorkSequenceImpl#getSuccessor <em>Successor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkSequenceImpl extends ProcessElementImpl implements WorkSequence
{
  ...
  {
    return TextSimplePDLPackage.Literals.WORK_SEQUENCE;
  }
    ...
    if (predecessor != null && predecessor.eIsProxy())
    {
      ...
      if (predecessor != oldPredecessor)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TextSimplePDLPackage.WORK_SEQUENCE__PREDECESSOR, oldPredecessor, predecessor));
      }
    }
    return predecessor;
  }
  ...
  public void setPredecessor(WorkDefinition newPredecessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.WORK_SEQUENCE__PREDECESSOR, oldPredecessor, predecessor));
  }
  ...
  public WorkDefinition getSuccessor()
  {
    if (successor != null && successor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TextSimplePDLPackage.WORK_SEQUENCE__SUCCESSOR, oldSuccessor, successor));
      }
    }
    return successor;
  }
  ...
  public void setSuccessor(WorkDefinition newSuccessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TextSimplePDLPackage.WORK_SEQUENCE__SUCCESSOR, oldSuccessor, successor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TextSimplePDLPackage.WORK_SEQUENCE__PREDECESSOR:
        if (resolve) return getPredecessor();
        return basicGetPredecessor();
      case TextSimplePDLPackage.WORK_SEQUENCE__SUCCESSOR:
