 ...
 * @generated
 */
public class TextSimplePDLSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        fr.n7.simplePDL.textSimplePDL.Process process = (fr.n7.simplePDL.textSimplePDL.Process)theEObject;
      ...
      case TextSimplePDLPackage.PROCESS_ELEMENT:
      {
   ...
   * @generated
   */
  public T caseProcess(fr.n7.simplePDL.textSimplePDL.Process object)
  {
    return null;
  }
