...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	public EAttribute getNeed_NbRessources() {
	...
	public void createPackageContents() {
		...
		createEAttribute(needEClass, NEED__NB_RESSOURCES);
		createEReference(needEClass, NEED__RESSOURCE);
		createEReference(needEClass, NEED__WORK_DEFINITION);
	...
	public void initializePackageContents() {
		...
		initEReference(getGuidance_Elements(), this.getProcessElement(), null, "elements", null, 1, 1, Guidance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(needEClass, Need.class, "Need", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNeed_NbRessources(), ecorePackage.getEInt(), "nbRessources", null, 0, 1, Need.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRessource_Needs(), this.getNeed(), null, "needs", null, 0, -1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
