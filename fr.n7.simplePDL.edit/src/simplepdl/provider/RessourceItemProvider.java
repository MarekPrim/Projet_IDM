...
public class RessourceItemProvider extends ProcessElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNbRessourceDisponiblePropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Nb Ressource Disponible feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNbRessourceDisponiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_nbRessourceDisponible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_nbRessourceDisponible_feature", "_UI_Ressource_type"),
				 SimplepdlPackage.Literals.RESSOURCE__NB_RESSOURCE_DISPONIBLE,
				 true,
				 false,
				 false,
