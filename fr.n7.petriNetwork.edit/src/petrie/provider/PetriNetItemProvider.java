...
/**
 * This is the item provider adapter for a {@link petrie.PetriNet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PetriNetItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetriePackage.Literals.PETRI_NET__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetriePackage.Literals.PETRI_NET__PETRI_ELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PetriNet.class)) {
			case PetriePackage.PETRI_NET__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PetriePackage.PETRI_NET__PETRI_ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetriePackage.Literals.PETRI_NET__PETRI_ELEMENTS,
				 PetrieFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(PetriePackage.Literals.PETRI_NET__PETRI_ELEMENTS,
				 PetrieFactory.eINSTANCE.createPlace()));

		newChildDescriptors.add
			(createChildParameter
				(PetriePackage.Literals.PETRI_NET__PETRI_ELEMENTS,
				 PetrieFactory.eINSTANCE.createArcSimple()));

		newChildDescriptors.add
			(createChildParameter
				(PetriePackage.Literals.PETRI_NET__PETRI_ELEMENTS,
				 PetrieFactory.eINSTANCE.createArcRead()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return PetrieEditPlugin.INSTANCE;
	}
