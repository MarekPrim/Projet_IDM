 ...
 *******************************************************************************/
package fr.n7.petriNet.testAcceleo.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fr/n7/petriNet/testAcceleo/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
         ...
         */
    	if (!isInWorkspace(PetriePackage.class)) {
            // The normal package registration if your metamodel is in a plugin.
       	  resourceSet.getPackageRegistry().put(PetriePackage.eINSTANCE.eNS_URI, PetriePackage.eINSTANCE);
         }
    }
